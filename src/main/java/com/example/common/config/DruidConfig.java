...
import com.example.common.constants.DruidConstants;
...
import static com.example.common.constants.DruidConstants.*;
...
public class DruidConfig implements EnvironmentAware {
    ...
    public static List<String> customDataSourceNames = new ArrayList<>();
    ...
    public DataSource dataSourcebuild(MutablePropertyValues dataSourcePropertyValue){
        ...
        String type = dataSourcePropertyValue.get("spring.datasource.druid.type").toString();
